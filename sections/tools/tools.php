...
<? } if (check_perms('site_recommend_own') || check_perms('site_manage_recommendations')) { ?>
			<tr><td><a href="tools.php?action=recommend">Staff picks</a></td></tr>
<? } if (check_perms('users_mod')) { ?>
			<tr><td><a href="tools.php?action=email_blacklist">Email Blacklist</a></td></tr>
			<tr><td><a href="tools.php?action=pendingct">Custom Title Approval</a></td></tr>
			<tr><td><a href="tools.php?action=balance">Balance Review</a></td></tr>
			<tr><td><a href="tools.php?action=leech">Ghost-leech detection</a></td></tr>
			<tr><td><a href="tools.php?action=bplog">Bonus Log</a></td></tr>
<? } ?>
		</table>
	</div>
	<div class="permission_container">
...
<? } if (check_perms('site_debug')) { ?>
			...
			<tr><td><a href="tools.php?action=danger_sandbox">danger's Sandbox</a></td></tr>
