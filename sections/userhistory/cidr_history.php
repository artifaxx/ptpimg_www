...
?>
	<h2>Cidr history for <a href="/user.php?id=<?=$UserID?>"><?=$Username?></a></h2>
...
foreach($Results as $Result) {
	list($Cidr, $StartTime, $EndTime, $UserIDs, $UserStartTimes, $UserEndTimes, $Usernames, $UsersEnabled, $UsersDonor, $UsersWarned) = $Result;
	$HasDupe = false;
